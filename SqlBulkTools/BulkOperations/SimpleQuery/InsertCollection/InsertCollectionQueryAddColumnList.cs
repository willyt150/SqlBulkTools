...
namespace SqlBulkTools
{
    ...
    public class InsertCollectionQueryAddColumnList<T>
    {
        ...
        public InsertCollectionQueryAddColumnList(IEnumerable<T> smallCollection, string tableName, HashSet<string> columns, string schema,
        ...
        /// </summary>
        /// <returns></returns>
        public InsertCollectionQueryReady<T> Insert()
        {
            return new InsertCollectionQueryReady<T>(_smallCollection, _tableName, _schema, _columns, _customColumnMappings,
        ...
        /// </param>
        /// <returns></returns>
        public InsertCollectionQueryAddColumnList<T> CustomColumnMapping(Expression<Func<T, object>> source, string destination)
        {
