...
namespace SqlBulkTools
{
    ...
    public class InsertCollectionQueryAddColumn<T>
    {
        ...
        public InsertCollectionQueryAddColumn(IEnumerable<T> smallCollection, string tableName, HashSet<string> columns, string schema,
        ...
        /// </param>
        /// <returns></returns>
        public InsertCollectionQueryAddColumn<T> CustomColumnMapping(Expression<Func<T, object>> source, string destination)
        {
